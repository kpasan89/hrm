...
@ManagedBean
@ViewScoped
public class MsIssueController implements Serializable {
    ...
    public List<ItemUnit> getSelectedItems() {
        if (getUnit() == null) {
            return null;
        }
        String temSql;
    ...
    public List<ItemUnit> selectedItems(String searchText) {
        if (getUnit() == null) {
            return null;
        }
        String temSql;
